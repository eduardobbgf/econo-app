import 'package:econo_app/screens/login_page.dart';
import 'package:econo_app/screens/profile_page.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print(userProvider.user?.photoURL);
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if (snapshot.connectionState == ConnectionState.active) {
          ...
          return DocumentsListWidget(documents: documents);
        }
    ...
    return isEmailVerified
        ...
        : Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Email não verificado, caso já tenha sido clique em atualizar.",
                  style: TextStyle(
                    fontSize: 14.0,
